...
Tracking_SensitiveDetector_Hit::Tracking_SensitiveDetector_Hit(G4ThreeVector pos, G4ThreeVector momDir, G4String name) : fPosition(pos), fMomentumDirection(momDir), fVolumeName(name){
